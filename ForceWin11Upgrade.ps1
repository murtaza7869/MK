...
$downloadedFilePath = $outputDir + "Windows11InstallationAssistant.exe"
...
## Start Windows 10 Update Helper now. Add "/NoRestartUI" in commandline if you don't want to reboot the machine.
